...
parser.add_argument('--checkpoint-dir', default='./hypotheses/temp_run/', type=str,
...
def main_worker(gpu, args, mode=None):
    if mode == 'single':
        args.ngpus_per_node = torch.cuda.device_count()
        args.rank = 0
        args.dist_url = 'tcp://localhost:58472'
    ...
    dataset = torchvision.datasets.ImageFolder(args.data, Transform()) #train
...
if __name__ == '__main__':
    # main()
    main_worker(0, args, mode = 'single')